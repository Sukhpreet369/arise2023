						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                            <a href="export.php?class=class8">Export Data</a>                       
                                       ...
                                       <!--<tr>
                                        ...
                                        <?php
                                            ...
                                            <tr>
												...
												<td><a href="edit-detail.php?sid=<?php echo $rw['sid'];?>&class=<?php echo $class;?>&classfile=class-8">Edit</a></td>
												<td><a href="del.php?sid=<?php echo $rw['sid'];?>&class=<?php echo $class;?>&classfile=class-8" onclick="return confirmation()">Delete</a></td>
                                            </tr>
												<?php
												}
												?>
