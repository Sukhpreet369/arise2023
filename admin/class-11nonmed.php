					...
					<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                     <a href="export.php?class=class11nonmed">Export Data</a>                              
                                       ...
                                       <!--<tr>
                                        ...
                                        <?php
                                            ...
                                            <tr>
												...
												<td><a href="edit-detail.php?sid=<?php echo $rw['sid'];?>&class=<?php echo $class;?>&classfile=class-11nonmed">Edit</a></td>
												<td><a href="del.php?sid=<?php echo $rw['sid'];?>&class=<?php echo $class;?>&classfile=class-11nonmed" onclick="return confirmation()">Delete</a></td>
                                            </tr>
												<?php
												}
												?>
