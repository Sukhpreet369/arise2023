...
<div class="row">
	...
	<form id="msform" name="msform">
            <!-- progressbar -->
            <ul id="progressbar">
            <li class="active">Verify Mobile</li>
			...
			<div class="row">
					<div class="col-sm-6">
						...
						<label for="fmobileno1">Father Mobile Number</label>
						<input type="text" class="form-control" id="fmobileno"  name="fmobileno1" placeholder="" required>
						<span id="fmobileno1" class="error-color"></span>
						</div>
					</div> 
					<div class="col-sm-6">
						<div class="form-group">
            ...
            <fieldset>
                ...
                <h3 class="fs-subtitle">Test Payment</h3>
